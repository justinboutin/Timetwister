...
class FivePlayer : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.five_player, container, false)
        ...
        playerFiveTimer.setOnClickListener {
            (activity as PlayingActivity).timerClicked(playerFiveTimerText, playerOneTimerText)
        }
